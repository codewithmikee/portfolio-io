...
export const mockProfiles: DeveloperProfile[] = [
  {
    ...
    certifications: [
      ...
      },
      {
        ...
        date: "2022-09",
        description:
          "First place for build  ing an innovative AI-powered productivity tool",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        title: "DEV Community Blog - Laravel & Backend Development",
        description:
          "Active technical writer on DEV Community sharing insights on Laravel best practices, timezone management, API development, and backend architecture. Published articles on Carbon timezone handling, Laravel API boilerplates, and advanced PHP development techniques.",
        image:
        ...
        liveUrl: "https://dev.to/codewithmikee",
        githubUrl: "https://github.com/codewithmikee",
        featured: true,
        keyFeatures: [
          "Timezone management and Carbon usage best practices",
          "Laravel API boilerplate development with Sanctum",
          "Advanced PHP development techniques",
          "Backend architecture and microservices patterns",
          "Real-world problem-solving tutorials",
        ],
        keyAchievements: [
          "Published comprehensive timezone management guides",
          "Shared Laravel API boilerplate with Sanctum integration",
          "Demonstrates expertise in backend development",
    ...
    experience: [
      ...
      },
      {
        ...
        endDate: "2023-03",
        description:
          "Developed cross-platform Flutter applications for food delivery platform. Integrated with External APIs for order management and real-time tracking.",
        technologies: ["Flutter", "Dart", "Laravel API", "WebSockets"],
        employmentType: "full-time",
        keyAchievements: [
          "Developed complete Flutter application serving 1000+ daily active users",
          "Integrated third party tools like Firebase, Sentry, RazorPay",
          "Handled publishing the app to the app store and google play store",
        ],
      },
      {
        id: "exp-farka-php",
        ...
        endDate: "2019-12",
        description:
          "Developed university management system using Laravel backend and React frontend. Created school inspection management system deployed across 50+ institutions.",
        technologies: ["Laravel", "React", "MySQL", "JavaScript", "Bootstrap"],
        employmentType: "full-time",
        keyAchievements: [
          "Developed comprehensive university management system using Laravel backend and React frontend",
